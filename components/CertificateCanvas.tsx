...
export default function CertificateCanvas({ courseName, completedDate, xpEarned, onClose }: Props) {
  ...
  function handleLinkedIn() {
    const text = encodeURIComponent(
      `I just completed "${courseName}" on EnglishUp! 🎓 Ready to take my English to the next level.`
    );
    const url = encodeURIComponent('https://englishup.app');
        ...
        >
          ...
          <div className="flex gap-3 mt-4">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#0077B5]/20 border border-[#0077B5]/40 text-[#5bb8f5] hover:bg-[#0077B5]/30 font-semibold transition-colors"
